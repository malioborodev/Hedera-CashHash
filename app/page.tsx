  ...
  return (
    <div className="relative">
      ...
      <section className="py-10 md:py-16">
        <div className="max-w-4xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/70">
            <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" /> On Hedera • Secure with HashPack
          </div>
          ...
          <div className="mt-6 flex items-center gap-3">
            <Link href="/invoices" className="px-4 py-2 rounded bg-emerald-500 hover:bg-emerald-600 active:scale-[0.98] transition">Launch App</Link>
            <a href="#how-it-works" className="px-4 py-2 rounded border border-white/10 hover:border-white/20 transition">How it works</a>
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="rounded border border-white/10 bg-white/5 p-4 hover:bg-white/10 transition">
      ...
      <section className="mt-12 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="rounded border border-white/10 bg-white/5 p-6 hover:bg-white/10 transition">
        ...
        <div className="rounded-xl border border-white/10 bg-gradient-to-r from-emerald-500/10 to-indigo-500/10 p-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <Link href="/invoices" className="px-4 py-2 rounded bg-emerald-500 hover:bg-emerald-600 transition">Go to Invoices</Link>
              <Link href="/events" className="px-4 py-2 rounded border border-white/10 hover:border-white/20 transition">View Events</Link>
            </div>
          </div>
        </div>
      </section>
